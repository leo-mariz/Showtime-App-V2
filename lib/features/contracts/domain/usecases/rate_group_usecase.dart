...
/// UseCase: Avaliar grupo (pelo cliente/anfitrião)
///
/// RESPONSABILIDADES:
...
/// - Chamar a function rateGroup para persistir a avaliação
class RateGroupUseCase {
  ...
  Future<Either<Failure, void>> call({
    ...
    try {
      ...
      await contractsFunctions.rateGroup(
        contractUid,
        rating,
