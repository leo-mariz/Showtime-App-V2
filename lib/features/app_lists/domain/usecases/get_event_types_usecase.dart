...
/// UseCase: Buscar lista de tipos de evento
/// 
/// RESPONSABILIDADES:
/// - Buscar tipos de evento do repositório (cache primeiro, depois remoto)
...
class GetEventTypesUseCase {
  ...
  Future<Either<Failure, List<AppListItemEntity>>> call() async {
    try {
      final result = await repository.getListItems(AppListType.eventTypes);
