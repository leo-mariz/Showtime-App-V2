...
class ArtistEventDetailScreen extends StatelessWidget {
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            ] else if (_status != EventStatusEnum.rejected && 
                       _status != EventStatusEnum.finished) ...[
              CustomButton(
      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            child: Text(
              (event.nameContractor ?? 'A')[0].toUpperCase(),
              style: textTheme.titleMedium?.copyWith(
                color: onPrimary,
                fontWeight: FontWeight.w600,
              ),
