...
/// UseCase: Buscar lista de assuntos de suporte
/// 
/// RESPONSABILIDADES:
/// - Buscar assuntos de suporte do repositório (cache primeiro, depois remoto)
/// - Retornar apenas itens ativos, ordenados
class GetSupportSubjectsUseCase {
  final IAppListsRepository repository;

  GetSupportSubjectsUseCase({
    required this.repository,
  });

  Future<Either<Failure, List<AppListItemEntity>>> call() async {
    try {
      final result = await repository.getListItems(AppListType.supportSubjects);
