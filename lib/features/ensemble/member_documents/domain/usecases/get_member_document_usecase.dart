...
/// Use case: buscar um documento do integrante por tipo (identity ou antecedents).
class GetMemberDocumentUseCase {
  final IMemberDocumentsRepository repository;

  GetMemberDocumentUseCase({required this.repository});

  Future<Either<Failure, MemberDocumentEntity?>> call(
    String artistId,
    String ensembleId,
    String memberId,
    String documentType,
