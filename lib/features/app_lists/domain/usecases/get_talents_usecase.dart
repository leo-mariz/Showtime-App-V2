...
/// UseCase: Buscar lista de talentos
/// 
/// RESPONSABILIDADES:
/// - Buscar talentos do repositório (cache primeiro, depois remoto)
...
class GetTalentsUseCase {
  ...
  Future<Either<Failure, List<AppListItemEntity>>> call() async {
    try {
      final result = await repository.getListItems(AppListType.talents);
