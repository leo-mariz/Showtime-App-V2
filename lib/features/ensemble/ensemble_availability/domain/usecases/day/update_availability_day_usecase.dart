...
/// );
/// await updateAvailabilityDayUseCase(ensembleId, updatedDay);
/// 
...
/// await updateAvailabilityDayUseCase(ensembleId, updatedDay);
/// ```
class UpdateEnsembleAvailabilityDayUseCase {
  final IEnsembleAvailabilityRepository repository;
  final GetEnsembleAvailabilityByDateUseCase getByDate;

  UpdateEnsembleAvailabilityDayUseCase({
  ...
  Future<Either<Failure, AvailabilityDayEntity>> call(
    ...
    try {
      ...
      // ════════════════════════════════════════════════════════════════
      final getDayResult = await getByDate(ensembleId, dayEntity.date);
